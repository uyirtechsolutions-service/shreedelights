...
export default function OrderCake() {
  ...
  const onSubmit = async (data: OrderFormData) => {
    ...
    const emailPayload = {
      ...
      total_amount_label:     orderTotalLabel,
      total_amount_string:    orderTotalLabel,
      total_amount_value:     orderAmount,
      total_amount_numeric:   orderAmount,
      total_price:            orderTotalLabel,
      total_price_value:      orderAmount,
      total_price_string:     orderTotalLabel,
      order_total:            orderAmount,
      order_total_amount:     orderAmount,
      order_total_label:      orderTotalLabel,
      orderTotal:             orderAmount,
      orderTotalLabel:        orderTotalLabel,
      orderTotalString:       orderTotalLabel,
      amount:                 orderAmount,
      amount_label:           orderTotalLabel,
      amount_string:          orderTotalLabel,
      orderAmount:            orderAmount,
      totalAmount:            orderAmount,
      totalAmountLabel:       orderTotalLabel,
      totalAmountString:      orderTotalLabel,
      total_label:            orderTotalLabel,
      total_text:             orderTotalLabel,
      grand_total:            orderTotalLabel,
      grand_total_value:      orderAmount,
